...
export default {
  ...
  data() {
    if (this.$route.params.typeEntry === 'Edit') {
      return {
        accounts: [],
        categories: [],
        ...
        record: {
          type: this.$route.params.records.type,
          amount: this.$route.params.records.amount,
          date: this.$route.params.records.date,
          accountId: this.$route.params.records.account.id,
          categoryId: this.$route.params.records.category.id,
          description: this.$route.params.records.description,
          tags: this.$route.params.records.tags,
          note: this.$route.params.records.note,
          id: this.$route.params.records.id
        },
  ...
  methods: {
    ...
    async submit() {
      try {
        const typeEntry = this.$route.params.typeEntry
        if (typeEntry === 'Edit') {
          console.log('Modo Edição')
          const record = await RecordsService.editRecords(this.record)
          console.log('Record: ', record)
          this.$router.push('/dashboard/records').location.reload().catch(() => { })
        } else {
